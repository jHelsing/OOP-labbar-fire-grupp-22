...
public class KortTest extends JFrame implements ActionListener {
  ...
  JPanel p = new JPanel();
  int test = 1;
  JLabel lab = new JLabel("Test 1: Nu skall det visas en vit knapp. Klicka pa knappen!", JLabel.CENTER);

  public KortTest() {
    setTitle("Korttest");
    if (!(k1.getClass().getGenericSuperclass().equals((new JButton()).getClass())) &&
        !(k1.getClass().getGenericSuperclass().equals((new JColorfulButton()).getClass()))) {
      showMessageDialog(null, "Klassen Kort är ingen JButton eller JColorfulButton");
      System.exit(1);
    }
  ...
  public void actionPerformed(ActionEvent e) {
    if (test == 1) {
      ...
      lab.setText("Test 2: Nu skall det visas en blå knapp. Klicka pa knappen!");
    }
    else if (test == 2) {
      ...
      lab.setText("Test 3: Nu skall det visas en blå knapp med en röd cirkel. Klicka pa knappen!");
    }
    else if (test == 3) {
      ...
      k1.setStatus(Kort.Status.DOLT);
      lab.setText("Test 4: Nu skall det visas en blå knapp. Klicka pa knappen!");
    }
    else if (test == 4) {
      if (k1.getStatus() != Kort.Status.DOLT) {
        showMessageDialog(this, "Fel i getStatus eller setStatus");
      ...
      k1.setStatus(Kort.Status.SYNLIGT);
      lab.setText("Test 5: Nu skall det visas en blå knapp med en röd cirkel. Klicka pa knappen!");
    }
    else if (test == 5) {
      if (k1.getStatus() != Kort.Status.SYNLIGT) {
        showMessageDialog(this, "Fel i getStatus eller setStatus");
      ...
      lab.setText("Test 6: Nu skall det visas en vit knapp. Klicka pa knappen!");
    }
    else if (test == 6) {
      if (k1.getStatus() != Kort.Status.SAKNAS) {
        showMessageDialog(this, "Fel i getStatus eller setStatus");
      ...
      lab.setText("Test 7: Nu skall det visas en blå knapp. Klicka pa knappen!");
    }
    else if (test == 7) {
      ...
      lab.setText("Test 8: Nu skall det visas en blå knapp med en gul cirkel. Klicka pa knappen!");
    }
    else if (test == 8) {
      ...
      lab.setText("Test 9: Nu skall det visas en gul knapp med en svart cirkel. Klicka pa knappen!");
    }
    else if (test == 9) {
